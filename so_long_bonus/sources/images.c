...
/*   Updated: 2024/05/08 13:33:07 by akaya-oz      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
bool	sl_image_init(t_game *my_game, t_map *my_map)
{
	...
	if (my_game->char_tx == NULL || my_game->wall_tx == NULL
		...
		|| my_game->backgr_tx == NULL || my_game->wolf_tx == NULL
		|| my_game->gameover_tx == NULL || my_game->steps_img == NULL)
		return (false);
	return (true);
}
...
bool	sl_text_to_img(t_map *my_map, t_game *my_game)
{
	...
	if (my_game->char_img == NULL || my_game->wall_img == NULL
		...
		|| my_game->backgr_img == NULL || my_game->wolf_img == NULL
